...
<form action="<?php echo e(route('update_profile')); ?>" method="post" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
...
<input class="c-input" type="text" id="name" name="name" value="<?php echo e($user->name); ?>">
</div>

<div class="c-field u-mb-medium">
<label class="c-field__label" for="user-email">Email Address</label>
<input class="c-input" type="text" id="user-email" name="email" value="<?php echo e($user->email); ?>">
</div>
...
<div class="col-xl-4">
<div class="c-field u-mb-medium">
<label class="c-field__label" for="user-facebook">Facebook</label>
<input class="c-input" type="text" id="user-facebook" name="facebook" value="<?php echo e($user->profile->facebook_url); ?>">
</div>
<div class="c-field u-mb-medium">
<label class="c-field__label" for="user-twitter">Twitter</label>
<input class="c-input" type="text" id="user-twitter" name="twitter" value="<?php echo e($user->profile->twitter_url); ?>">
</div>
...
<img class="c-avatar__img" src="<?php echo e($user->profile->avatar); ?>" alt="<?php echo e($user->name); ?>">
</div>
<h5><?php echo e($user->name); ?></h5>
<p class="u-pb-small u-mb-small u-border-bottom">
    <textarea class="uk-textarea" name="description" id="" cols="20" rows="5" placeholder="Enter Your Desription Here"><?php echo e($user->profile->description); ?></textarea>
</p>
<p class="u-h4">
<a class="u-mr-xsmall" href="<?php echo e($user->profile->facebook_url); ?>" target="_blank">
<i class="feather icon-facebook"></i>
</a>
<a class="u-mr-xsmall" href="<?php echo e($user->profile->twitter_url); ?>" target="_blank">
