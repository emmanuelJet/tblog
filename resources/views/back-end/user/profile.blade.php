...
<input class="c-input" type="text" id="user-facebook" name="facebook" value="{{ $user->profile->facebook_url }}">
</div>
<div class="c-field u-mb-medium">
...
<p class="u-pb-small u-mb-small u-border-bottom">
    <textarea class="uk-textarea" name="description" id="" cols="20" rows="5" placeholder="Enter Your Desription Here">{{ $user->profile->description }}</textarea>
</p>
<p class="u-h4">
<a class="u-mr-xsmall" href="{{ $user->profile->facebook_url }}" target="_blank">
