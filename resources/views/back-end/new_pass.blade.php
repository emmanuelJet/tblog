        ...
        <div class="c-card c-card--center">
            ...
            <form method="POST" action="{{ route('new_pass') }}">
                ...
                <div class="c-field">
                    ...
                    <input id="password" name="password" class="c-input u-mb-small" type="password" placeholder="Your New Password">

                </div>

                <div class="c-field">
                    <label class="c-field__label">Confirm Password</label>
                    <input id="password-confirm" class="c-input u-mb-small" name="password_confirmation" type="password" placeholder="Your New Password">
                </div>
