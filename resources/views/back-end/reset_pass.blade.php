        ...
        <div class="c-card c-card--center">
            ...
            <form action="{{ route('password.email') }}" method="POST">
                ...
                <div class="c-field">
                    ...
                    <input class="c-input u-mb-small" type="email" placeholder="Your Email" id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ $email ?? old('email') }}">
